...
map_modules:
	...
	.byte	0xa1, 0x69, 0x80, 0x20, 0x44, 0xf6, 0xd4, 0x49, 0x86, 0x0, 0xce, 0x7a, 0x67, 0x3b, 0x45, 0x2b	// module_uuid: 208069a1-f644-49d4-8600-ce7a673b452b
	...
	.byte	0xf2, 0x1b, 0xf8, 0x62, 0x7, 0x8, 0x38, 0x47, 0xb5, 0xe7, 0xbf, 0x79, 0x22, 0x29, 0x99, 0x7f	// module_uuid: 62f81bf2-0807-4738-b5e7-bf792229997f
	.word	0x3	// entry_count
	.word	0x0	// duplicate_count
	.xword	.L.module24_managed_to_java	// map
	.xword	0	// duplicate_map
	.xword	map_aname.24	// assembly_name: LNT.Android
	.xword	0x0	// image
	.word	0x0	// java_name_width
	.zero	4
	.xword	0x0	// java_map
...
map_java:
	...
	.ascii	"crc64cc262a4683f57934/MainActivity"	// java_name
	.zero	67	// byteCount == 34; fixedWidth == 101; returned size == 101
	.zero	3

	.word	0x18	// module_index
	.word	0x2000003	// type_token_id
	.ascii	"crc64cc262a4683f57934/MyWebViewRenderer"	// java_name
	.zero	62	// byteCount == 39; fixedWidth == 101; returned size == 101
	.zero	3

	.word	0x18	// module_index
	.word	0x2000006	// type_token_id
	.ascii	"crc64cc262a4683f57934/MyWebViewRenderer_ExtendedWebViewClient"	// java_name
	.zero	40	// byteCount == 61; fixedWidth == 101; returned size == 101
	.zero	3
